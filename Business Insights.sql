...
SELECT * FROM dbo.customer_behaviour_analysis
...
-- Impact :- 
            ...
            -- Reduce unnecessory discount costs
...
-- Business Problem :- Lack of understanding of revenue contribution by gendeer segments.
...
--Business Problem :- No visibility into product performance based on the customer satisfaction.
...
--Impact :-
            ...
            --Encourages premium shipping adaoption
            --Increase average order value

--7> Do subscribed users spend more? Compare average speed and total revenue between subscribers and non-subscribers.
SELECT * FROM customer_behaviour_analysis
...
--Impact :- 
            --Improves products placement and recommendation
...
--Impact :- 
            ...
            --Increases customer retention strategy
